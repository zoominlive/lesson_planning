        ...
        <Card className="material-shadow">
          <CardContent className="p-2">
            <TabsList className="grid w-full grid-cols-4 bg-transparent">
              <TabsTrigger 
                value="calendar" 
                className="flex items-center justify-center py-3 px-6 rounded-lg font-semibold transition-all duration-300 data-[state=active]:bg-gradient-to-r data-[state=active]:from-coral-red data-[state=active]:to-turquoise data-[state=active]:text-white"
